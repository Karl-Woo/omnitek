      ...
      <div className="solution-text">
        ...
        <div className="left-right-about">
          <div className="right-text">
            <div className="l-space"></div>
            <p>
              Whether you need high-performance cables for a specific project or
              a custom solution designed to your specifications, our team is
              here to help you achieve your goalsOmntiek is dedicated to the
              design, development and manufacturing of cable for microwave coax,
              micro coax, high data rate, optical and composite constructions.{" "}
            </p>
            ...
            <p>
              ...
              transmission performance define how your product of system quality
              and we optimize our products to meet your needs.{" "}
            </p>
            <div className="m-space"></div>
            <p>
              ...
              performance. We serve the demanding industries of: automated test
              systems, RF systems, medical imaging, aviation systems and custom
